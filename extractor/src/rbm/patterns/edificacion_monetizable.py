...
def edificacion_monetizable():
    return  list([
        #con construcción
        [{"LOWER": {"IN":CON_SINONIMOS}},{"LOWER": {"IN":UN_SINONIMOS},"OP":"?"},{"LIKE_NUM":True,"OP":"?"},{"LOWER":{"IN":CONSTRUCCION_SINONIMOS}}],
