...
CONSTRUCCION_SINONIMOS = ["vivienda", "viviendas", "depto", "deptos", "departamento", "departamentos", "pileta", "piletas", "piscina", "piscinas", "edificado", "edificados", "deposito", "depósito", "depositos", "depósitos", "construcción", "construccion", "construcciones", "zócalo", "zocalo", "zocalos", "edificación", "edificacion", "edificaciones", "quincho", "quinchos", "galpon", "galpón", "galpones", "local", "locales", "casa", "casas", "casita", "casitas", "comedor", "comedores", "cocina", "cocinas", "habitación", "habitacion", "habitaciones", "parrilla", "parrillas", "loza", "lozas", "contrapiso", "contrapisos", "garaje", "garajes", "cabaña", "cabañas", "chalet", "chalets", "dormitorio", "dormitorios", "cochera", "cocheras", "ventana", "ventanas", "living", "livings", "lavadero", "lavaderos", "pileta", "piletas", "guardacoche", "guardacoches", "platea", "plateas", "piso", "pisos", "muro", "muros", "hall", "halls", "terraza", "terrazas", "parrilla", "parrillas", "garage", "garages", "cocina", "cocinas", "lavadero", "lavaderos", "balcón", "balcon", "balcones", "comedor", "comedores", "galería", "galeria", "galerías", "galerias", "playroom", "playrooms", "local", "locales", "pórtico", "póritcos", "portico", "porticos", "porche", "porches"]
...
PALABRAS_CLAVE_MEJORADO = ["mejora", "mejoras", "mejorado", "mejorada", "alambrado", "alambrada","paredón", "paredon", "paredones", "portón", "porton", "portones", "cerco", "cercos", "medianera", "medianeras", "cercado", "cercados"]
